...
- `src/adapters/idealista/`: detail-listing adapter for numeric `/inmueble/<id>/` URLs; search pages remain unsupported.
...
Idealista search-page parsing, Browser API, images, retries, concurrency, and publishing are intentionally out of scope for this milestone.
